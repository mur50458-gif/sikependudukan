...
import { LayoutDashboard, Users, UserRound, CalendarDays, FileSpreadsheet, ShieldCheck, LogOut } from 'lucide-react';
...
const TabCekBantuan = dynamic(() => import('@/components/TabCekBantuan'), { ssr: false });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-2 py-2 sm:px-4 sm:py-4 relative">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="cekbansos">
            <TabCekBantuan isAdmin={isAdmin} />
          </TabsContent>
